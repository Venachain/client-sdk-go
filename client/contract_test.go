...
func TestContractClient_NFTMint(t *testing.T) {
	...
	funcparam = append(funcparam,"{\"method\":\"mint\", \"data\":[{\"name\":\"abcd\",\"symbol\":\"ab\"," +
		"\"description\":\"abcdf1\",\"iprice\": 100, \"price\":100,\"url\":\"ww.qwe.com\",\"property\":\"p11210\",\"others\":\"123\"}]}")
...
func TestContractClient_verifyProofByRange(t *testing.T) {
	...
	result, _ := contract.Execute(context.Background(), txparam, funcname, funcparam, "0x0000000000000000000000000000000000000100")
	fmt.Println(result)
	contract.Client.RpcClient.Close()
	assert.True(t, result != nil)
}
